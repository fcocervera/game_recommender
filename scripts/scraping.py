...
def scrape_zip_codes():
    ...
    Scrapes website for relevant information ranging from user ratings to gameboard information.
    Stores the information in postgreSQL database.
    '''
    city = []
    state = []
    zip_codes = []
    ...
    # Grab the zip codes for the correspodnign city
